...
// earthImage.style.left = -1.1 * window.innerWidth/2 + "px";
...
//         var aboutTexts = document.getElementsByClassName("about-text");
//         for(let i = 0; i < aboutTexts.length; i++){
//             aboutTexts[i].style.fontSize = "0.9em";
//             aboutTexts[i].style.marginTop = "60%";
//         }
//     }
//     else{
//         var aboutTexts = document.getElementsByClassName("about-text");
//         for(let i = 0; i < aboutTexts.length; i++){
//             aboutTexts[i].style.fontSize = "1em";
//             aboutTexts[i].style.marginTop = "40%";
//         }
//     }
// }
